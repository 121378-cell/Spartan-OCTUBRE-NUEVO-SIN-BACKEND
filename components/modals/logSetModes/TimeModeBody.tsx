    ...
    return (
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center min-h-[350px]">
            ...
            <div className="flex flex-col items-center gap-4">
                <p className="text-sm font-medium text-spartan-text-secondary">DURACIÓN (Objetivo: {exercise.reps})</p>
                <div className="font-mono text-7xl text-spartan-text">{formatTime(duration)}</div>
            ...
            <div className="flex flex-col items-center">
                 <label className="block text-sm font-medium text-spartan-text-secondary mb-2">RPE (Esfuerzo Percibido)</label>
