...
const Modal: React.FC<ModalProps> = ({ children }) => {
  ...
  return (
    ...
    >
      <div 
        className={`bg-spartan-surface/90 backdrop-blur-md border rounded-lg shadow-xl p-6 w-full relative ${contentSizeClasses[size]} ${animationClasses[position]} ${criticalClasses}`}
