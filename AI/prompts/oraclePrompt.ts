...
export const oracleMilestoneSchema = {
    type: Type.ARRAY,
    items: {
        type: Type.OBJECT,
        properties: {
            title: { type: Type.STRING, description: "El título épico y temático del hito." },
            description: { type: Type.STRING, description: "Una descripción clara y motivadora de lo que se requiere para completar el hito." }
        },
