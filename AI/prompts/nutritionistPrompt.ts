    ...
    properties: {
        ...
        functionalFoods: {
            ...
            items: {
                ...
                properties: {
                    name: { type: Type.STRING },
                    benefit: { type: Type.STRING, description: "El beneficio específico para la salud intestinal." }
                },
                required: ["name", "benefit"]
            }
        },
        inflammatoryFoodsToLimit: {
            type: Type.STRING,
            description: "Una nota sobre los alimentos inflamatorios comunes a considerar limitar."
        }
    },
    required: ["macros", "timing", "supplements", "mealIdeas", "functionalFoods", "inflammatoryFoodsToLimit"]
};