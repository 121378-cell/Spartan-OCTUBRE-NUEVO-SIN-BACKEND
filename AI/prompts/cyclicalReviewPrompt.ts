...
export const cyclicalReviewSchema = {
    type: Type.OBJECT,
    properties: {
        decision: {
            type: Type.STRING,
            description: "La decisión estratégica: 'progress' o 'extend'."
        },
        reasoning: {
            type: Type.STRING,
            description: "La explicación clara y concisa de por qué se tomó esta decisión, dirigida al usuario."
        },
        focusPoints: {
            type: Type.ARRAY,
    ...
    required: ["decision", "reasoning", "focusPoints"]
};